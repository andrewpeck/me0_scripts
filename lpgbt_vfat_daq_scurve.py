...
def lpgbt_vfat_scurve(system, oh_select, vfat_list, channel_list, set_cal_mode, parallel, threshold, step, nl1a, l1a_bxgap, trim):
    ...
    for vfat in vfat_list:
        ...
        if threshold != -9999:
            ...
            write_backend_reg(get_rwreg_node("BEFE.GEM_AMC.OH.OH%i.GEB.VFAT%i.CFG_THR_ARM_DAC"%(oh_select,vfat)), threshold)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-z", "--trim", action="store", dest="trim", default="nominal", help="trim = nominal, up, down")
    ...
    # Running Phase Scan
    try:
        lpgbt_vfat_scurve(args.system, int(args.ohid), vfat_list, channel_list, cal_mode, args.parallel, threshold, step, nl1a, l1a_bxgap, args.trim)
