...
def fit_scurve(vfatList, scurve_result, oh, directoryName, verbose , channel_list):
    ...
    for vfat in vfatList:
        ...
        for channel in tqdm(range(128)):
            ...
            params, covMatrix = curve_fit(scurveFunc, scurveData[:,0], scurveData[:,1], p0=[1, 0, 10, 0.1], maxfev=100000) # fit data; returns optimized parameters and covariance matrix
