...
if __name__ == "__main__":
    ...
    if "_sbit_" in nd_dir_name:
        outdirname = "vfat_data/vfat_sbit_trimming_results"
    else:
        outdirname = "vfat_data/vfat_daq_trimming_results"
    try:
    ...
    now = now.replace(" ", "_")
    if "_sbit_" in nd_dir_name:
        outfilename = outdirname + "/" + oh + "_vfat_sbit_trimming_results_" + now + ".txt"
    else:
        outfilename = outdirname + "/" + oh + "_vfat_daq_trimming_results_" + now + ".txt"
